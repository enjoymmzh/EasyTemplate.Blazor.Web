...
namespace EasyTemplate.Blazor.Web.Components.Pages.Management.Logs.Log;
...
public partial class Log
{
    ...
    /// 注入实例
    /// </summary>
    [Inject] private SqlSugarRepository<SystemLog> _repository { get; set; }
    /// <summary>
    /// 
    /// </summary>
    ...
    private async Task OnChange(QueryModel<SystemLog> query)
        => await Query();
