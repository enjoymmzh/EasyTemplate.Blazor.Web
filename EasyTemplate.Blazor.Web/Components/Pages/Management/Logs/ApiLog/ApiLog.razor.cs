...
namespace EasyTemplate.Blazor.Web.Components.Pages.Management.Logs.ApiLog;
...
public partial class ApiLog
{
    ...
    /// 注入实例
    /// </summary>
    [Inject] private SqlSugarRepository<SystemLogApi> _repository { get; set; }
    /// <summary>
    /// 
    /// </summary>
    ...
    private async Task OnChange(QueryModel<SystemLogApi> query)
        => await Query();
